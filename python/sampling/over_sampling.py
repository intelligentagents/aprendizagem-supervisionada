...
# Installing imbalanced-learn in IDE: %pip install imblearn
# Installing imbalanced-learn via pip: pip install -U imbalanced-learn
# Installing the lib in CONDA: conda install -c conda-forge imbalanced-learn
